...
//go:generate minimock -i fisherman/configuration.Rule -o ./mocks/rule_mock.go
...
func (mmCheck *mRuleMockCheck) Expect(w1 io.Writer, a1 internal.AsyncContext) *mRuleMockCheck {
	...
	mmCheck.defaultExpectation.params = &RuleMockCheckParams{w1, a1}
...
func (mmCheck *mRuleMockCheck) When(w1 io.Writer, a1 internal.AsyncContext) *RuleMockCheckExpectation {
	...
	expectation := &RuleMockCheckExpectation{
		mock:   mmCheck.mock,
		params: &RuleMockCheckParams{w1, a1},
	}
...
func (mmCheck *RuleMock) Check(w1 io.Writer, a1 internal.AsyncContext) (err error) {
	...
	if mmCheck.inspectFuncCheck != nil {
		mmCheck.inspectFuncCheck(w1, a1)
	}

	mm_params := &RuleMockCheckParams{w1, a1}
	...
	if mmCheck.CheckMock.defaultExpectation != nil {
		...
		mm_got := RuleMockCheckParams{w1, a1}
	...
	if mmCheck.funcCheck != nil {
		return mmCheck.funcCheck(w1, a1)
	}
	mmCheck.t.Fatalf("Unexpected call to RuleMock.Check. %v %v", w1, a1)
	return
}
