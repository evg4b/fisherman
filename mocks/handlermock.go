...
// HandlerMock implements handlers.Handler
type HandlerMock struct {
	t minimock.Tester

	funcHandle          func(ctx *clicontext.CommandContext, args []string) (err error)
	inspectFuncHandle   func(ctx *clicontext.CommandContext, args []string)
	afterHandleCounter  uint64
	beforeHandleCounter uint64
	HandleMock          mHandlerMockHandle

	funcIsConfigured          func(config *config.HooksConfig) (b1 bool)
	inspectFuncIsConfigured   func(config *config.HooksConfig)
	afterIsConfiguredCounter  uint64
	beforeIsConfiguredCounter uint64
	IsConfiguredMock          mHandlerMockIsConfigured
}

// NewHandlerMock returns a mock for handlers.Handler
...
func (mmHandle *mHandlerMockHandle) Expect(ctx *clicontext.CommandContext, args []string) *mHandlerMockHandle {
	...
	mmHandle.defaultExpectation.params = &HandlerMockHandleParams{ctx, args}
...
func (mmHandle *mHandlerMockHandle) Inspect(f func(ctx *clicontext.CommandContext, args []string)) *mHandlerMockHandle {
...
func (mmHandle *mHandlerMockHandle) Set(f func(ctx *clicontext.CommandContext, args []string) (err error)) *HandlerMock {
	if mmHandle.defaultExpectation != nil {
...
// Then helper
func (mmHandle *mHandlerMockHandle) When(ctx *clicontext.CommandContext, args []string) *HandlerMockHandleExpectation {
	if mmHandle.mock.funcHandle != nil {
		mmHandle.mock.t.Fatalf("HandlerMock.Handle mock is already set by Set")
	}
	...
	expectation := &HandlerMockHandleExpectation{
		mock:   mmHandle.mock,
		params: &HandlerMockHandleParams{ctx, args},
	}
...
// Handle implements handlers.Handler
func (mmHandle *HandlerMock) Handle(ctx *clicontext.CommandContext, args []string) (err error) {
	...
	if mmHandle.inspectFuncHandle != nil {
		mmHandle.inspectFuncHandle(ctx, args)
	}

	mm_params := &HandlerMockHandleParams{ctx, args}
	...
	if mmHandle.HandleMock.defaultExpectation != nil {
		...
		mm_got := HandlerMockHandleParams{ctx, args}
	...
	if mmHandle.funcHandle != nil {
		return mmHandle.funcHandle(ctx, args)
	}
	mmHandle.t.Fatalf("Unexpected call to HandlerMock.Handle. %v %v", ctx, args)
	return
}
...
func (mmIsConfigured *mHandlerMockIsConfigured) Expect(config *config.HooksConfig) *mHandlerMockIsConfigured {
...
func (mmIsConfigured *mHandlerMockIsConfigured) Inspect(f func(config *config.HooksConfig)) *mHandlerMockIsConfigured {
...
func (mmIsConfigured *mHandlerMockIsConfigured) Set(f func(config *config.HooksConfig) (b1 bool)) *HandlerMock {
	if mmIsConfigured.defaultExpectation != nil {
...
// Then helper
func (mmIsConfigured *mHandlerMockIsConfigured) When(config *config.HooksConfig) *HandlerMockIsConfiguredExpectation {
	if mmIsConfigured.mock.funcIsConfigured != nil {
		mmIsConfigured.mock.t.Fatalf("HandlerMock.IsConfigured mock is already set by Set")
	}
...
// IsConfigured implements handlers.Handler
func (mmIsConfigured *HandlerMock) IsConfigured(config *config.HooksConfig) (b1 bool) {
