...
// ShouldBeDefined checks that the variable is not nil. In case when a variable is nil, it panic.
...
// ShouldBeNotEmpty checks that the string is not empty and should contains not whitespace symbols.
