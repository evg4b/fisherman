...
//go:generate minimock -i fisherman/configuration.VariablesExtractor -o ./testing/mocks/variables_extractor_mock.go

import (
	mm_configuration "fisherman/configuration"
	"sync"
...
// VariablesExtractorMock implements configuration.VariablesExtractor
type VariablesExtractorMock struct {
	t minimock.Tester

	funcGetFromBranch          func(branchName string) (v1 mm_configuration.Variables, err error)
	...
	funcGetFromTag          func(tag string) (v1 mm_configuration.Variables, err error)
...
// NewVariablesExtractorMock returns a mock for configuration.VariablesExtractor
...
func (mmGetFromBranch *mVariablesExtractorMockGetFromBranch) Return(v1 mm_configuration.Variables, err error) *VariablesExtractorMock {
	if mmGetFromBranch.mock.funcGetFromBranch != nil {
		mmGetFromBranch.mock.t.Fatalf("VariablesExtractorMock.GetFromBranch mock is already set by Set")
	}
	...
	mmGetFromBranch.defaultExpectation.results = &VariablesExtractorMockGetFromBranchResults{v1, err}
	return mmGetFromBranch.mock
}

//Set uses given function f to mock the VariablesExtractor.GetFromBranch method
func (mmGetFromBranch *mVariablesExtractorMockGetFromBranch) Set(f func(branchName string) (v1 mm_configuration.Variables, err error)) *VariablesExtractorMock {
	if mmGetFromBranch.defaultExpectation != nil {
...
func (e *VariablesExtractorMockGetFromBranchExpectation) Then(v1 mm_configuration.Variables, err error) *VariablesExtractorMock {
	e.results = &VariablesExtractorMockGetFromBranchResults{v1, err}
	return e.mock
}

// GetFromBranch implements configuration.VariablesExtractor
func (mmGetFromBranch *VariablesExtractorMock) GetFromBranch(branchName string) (v1 mm_configuration.Variables, err error) {
...
func (mmGetFromTag *mVariablesExtractorMockGetFromTag) Return(v1 mm_configuration.Variables, err error) *VariablesExtractorMock {
	if mmGetFromTag.mock.funcGetFromTag != nil {
		mmGetFromTag.mock.t.Fatalf("VariablesExtractorMock.GetFromTag mock is already set by Set")
	}
	...
	mmGetFromTag.defaultExpectation.results = &VariablesExtractorMockGetFromTagResults{v1, err}
	return mmGetFromTag.mock
}

//Set uses given function f to mock the VariablesExtractor.GetFromTag method
func (mmGetFromTag *mVariablesExtractorMockGetFromTag) Set(f func(tag string) (v1 mm_configuration.Variables, err error)) *VariablesExtractorMock {
	if mmGetFromTag.defaultExpectation != nil {
...
func (e *VariablesExtractorMockGetFromTagExpectation) Then(v1 mm_configuration.Variables, err error) *VariablesExtractorMock {
	e.results = &VariablesExtractorMockGetFromTagResults{v1, err}
	return e.mock
}

// GetFromTag implements configuration.VariablesExtractor
func (mmGetFromTag *VariablesExtractorMock) GetFromTag(tag string) (v1 mm_configuration.Variables, err error) {
